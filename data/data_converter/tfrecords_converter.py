...
def data_generator(save_dir, id_list, image_list, label_list, name_classes, weight_list=None, **data_preprocess):
    ...
    for data_n, filename in enumerate(id_list):
        ...
        progress_bar(len(id_list), data_n+1, "Generating : %s, Label Count: %s" % (filename, str(label_cnt)))
...
if __name__ == "__main__":
    ...
    image_dataset = glob(org_data_path + "*_MRI.nii")
    label_dataset = glob(org_data_path + "*_Label.nii")
